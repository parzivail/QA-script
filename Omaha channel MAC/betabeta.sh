...
printf 	"
	 THIS SCRIPT WILL ENABLE YOUR DEVICE TO DOWNLOAD INTERNAL BETA RELEASES
...
ssh root@10.11.99.1	" sed -i '/REMARKABLE_RELEASE_APPID=/d' .config/remarkable/xochitl.conf && 
